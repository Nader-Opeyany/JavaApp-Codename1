...
public class GameWorld {
    ...
    ArrayList<GameObject> holder = new ArrayList<GameObject>();
    ...
    public void init() {
        ...
        //Skyscrapers
        Skyscraper buildingOne = new Skyscraper(200, 300, 1, 20);
        Skyscraper buildingTwo = new Skyscraper(300, 400, 2, 20);
        Skyscraper buildingThree = new Skyscraper(400, 300, 3, 20);
        Skyscraper buildingFour = new Skyscraper(500, 400, 4, 20);

        //make an arraylist for all objects made in game
        holder.add((GameObject) player);
    ...
    public void collide(){
        Helicopter obj = (Helicopter)holder.get(0);
        obj.damageLevel += 50;
        if (obj.damageLevel >= 100){
            obj.lives--;
            System.out.println("You've lost a life form collision damage");
            obj.damageLevel = 0;//resets damage level
        }
    }
    public void refuel(){
        Helicopter obj = (Helicopter)holder.get(0);
