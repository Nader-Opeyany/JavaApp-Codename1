...
public class LastSkyScrapperClock extends Component {
    ...
    public LastSkyScrapperClock(GameWorld gw) {
        this.gw = gw;
        try {
    ...
    public void setSkyLabel(){
        Helicopter obj = (Helicopter)gw.holder.get(0);

        skyLabel(obj.lastSkyScrapperReached);
    }
    public void skyLabel(int gas){
