...
public class HeadingClock extends Component {

    GameWorld gw;
    Image[] digitImages = new Image[10];

    public int ledColor;
    private static final int numDigitsShowing = 4; // Heading only has 4 digits
    Image[] clockDigits = new Image[numDigitsShowing];

    public HeadingClock(GameWorld gw) {
        this.gw = gw;
        try {
    ...
    public void setHeadingLabel(){
        ...
        headingLabel(obj.heading);
    }
    public void headingLabel(int gas){
