...
public class DamageClock extends Component {

    GameWorld gw;
    Image[] digitImages = new Image[10];
    Image colonImage;
    public int ledColor;
    private static final int numDigitsShowing = 4; // Fuel only has 3 digits
    Image[] clockDigits = new Image[numDigitsShowing];

    public DamageClock(GameWorld gw) {
        this.gw = gw;
        try {
    ...
    public void setDamageLabel(){
        ...
        DamageLabel(obj.damageLevel);
    }
    public void DamageLabel(int gas){
